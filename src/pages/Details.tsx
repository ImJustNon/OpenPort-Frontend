                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 bg-[#1f1f1f] rounded-md px-5 py-8 mb-5">
                    ...
                    <div className="p-3 flex flex-col flex-wrap gap-4">
                        ...
                        <div className="flex flex-row mt-5 gap-2">
                            ...
                            <a className="px-3 py-2 bg-[#4d4d4d] text-[#d9d9d9] flex rounded-md font-bold items-center gap-2 cursor-pointer hover:bg-[#636363] duration-300" href={`https://openport-backend.vercel.app/api/v1/portfolio/download/${portDetails?.id}`} target="_blank" ><FontAwesomeIcon icon={faDownload} /><span>Download</span></a>
                        </div>
                    </div>
                </div>
                : 
